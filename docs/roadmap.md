...
> 4,179 首歌曲的 Credits、764 张发行物的 Catalog Number、1,039 位艺人的头像——纯人工录入不现实。
...
| 任务 | 说明 | 状态 |
|---|---|---|
| iTunes 最新发行抓取 | 更新至 2026-07-09，新增 18 个发行物、690 首曲目；总计 764 个发行物、4,179 首曲目 | ✅ 已完成 |
| 缺失曲目回退查询 | `fetch-album-tracks.ts` 在 lookup 无曲目时，按 `collectionId` 精确回退到歌曲搜索 | ✅ 已完成 |
